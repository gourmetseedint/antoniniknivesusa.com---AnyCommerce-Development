...
// *** -> as of 201342, the path /jsonapi/ can/should be used for all ajax calls in a store
			app.vars.jqurl = (document.location.protocol === 'file:') ? app.vars.testURL : ((document.location.protocol === 'http:') ? zGlobals.appSettings.http_app_url : zGlobals.appSettings.https_app_url);
