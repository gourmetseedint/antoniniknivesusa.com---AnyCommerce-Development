...
//what percentage of completion a single include represents (if 10 includes, each is 10%).
  ...
  if(resourcesLoaded == app.vars.rq.length) {
    ...
    $('#appPreView').empty().append("<h2>Uh Oh. Something seems to have gone wrong. </h2><h3><a href='http://www.antoniniknivesusa.com/'>Refresh</a></h3><p>Several attempts were made to load the store but some necessary files were not found or could not load. We apologize for the inconvenience. Please try 'refresh' and see if that helps.<br><b>If the error persists, please contact the site administrator</p>");
